  ...
  const STRATEGY_STATUS_DETAILS = [
    {
      ...
      items: [
        ...
        ["E4", "本益比小於 21.5", "採用官方估值 PER；缺資料或 PER 不適用時列為待補。"],
    ...
    },
    {
      ...
      items: [
        ...
        ["X2", "月營收年增率不可突然降溫超過 20 個百分點", "比較本月與上月年增率；若本月仍高於 200%，不觸發 X2。"],
